...
parser.add_argument('--model', default='videoanno/STCN-main/saves/stcn.pth')
parser.add_argument('--davis_path', default='/root/data/videoanno//DAVIS/2016')
#Karl改动，添加输出保存路径：
parser.add_argument('--output',default='videoanno//DAVIS/Output')
#原文：

...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--separate_flag', help='Flag to separate the images', default=True, type=bool)
        ...
        parser.add_argument('--num_workers', help='Number of datalaoder workers per process', type=int, default=4)
        ...
        if self.args['stage'] == 0:
            ...
            self.args['iterations'] = none_or_default(self.args['iterations'], 1500)
            self.args['steps'] = none_or_default(self.args['steps'], [1250])
            self.args['single_object'] = False
        else:
